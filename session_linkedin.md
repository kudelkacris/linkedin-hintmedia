...
| María Eugenia Fracchia | WhatsApp | 29/07/26 |
| Paul Puissegur | WhatsApp | 30/07/26 |
...
| Michelle LaTigresa Lores | Recontactar nov/26 — BD/partnerships, no scope de Hint ahora |
...
## Metodología actualizada 31/07/26

**Nueva estructura MSG2** — "Consulta + Valor":
- B1: Conectar con respuesta del prospecto
- B2: Consulta genuina (honrar contrato psicológico del MSG1)
- B3: Explicación de por qué preguntás (ahí aparece Hint — como consecuencia, no como pitch)
- B4: Dossier

Actualizado en CLAUDE.md el 31/07/26.
